...
<div style='text-align:center'>
    <h1 style='color:yellow;'>Industrial Copper Modeling Application</h1>
    <p style='color: white;'>Use this application to predict the selling price or status of copper items based on various parameters.</p>     
</div>
""", unsafe_allow_html=True)
